...
if it's QueryByTime, ask "{content}을 조회하시겠습니까?"
If it's QueryByQuery, ask "{content + time}을 조회하시겠습니까?"
If it's CreatePlan, ask "{content}을 추가하시겠습니까?"
If it's RecommandPlan, ask "{content}을 추천해드릴까요?"
